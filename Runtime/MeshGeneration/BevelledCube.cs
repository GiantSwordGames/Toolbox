...
namespace RapidPrototypingKit
{
    ...
    public abstract class ProceduralPrimitive : MonoBehaviour
    {
        ...
        private void RecalculateBoxCollider()
        {
            MeshRenderer meshRenderer = GetComponent<MeshRenderer>();
            ...
            try
            {
                // Ensure that a MeshRenderer and BoxCollider exist on the object
                if (meshRenderer != null)
                {
                    ...
                    if (boxCollider != null)
                    {
                        // Set the center of the BoxCollider to the center of the MeshRenderer's bounds
                        boxCollider.center = bounds.center - transform.position;

                        // Set the size of the BoxCollider to match the bounds size of the MeshRenderer
